...
function AdminLogin() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DOMAIN"]}/api/auth/login`, {
                method: "POST",
                headers: {
...
_s(AdminLogin, "Ppbzv4LmWi015HO+PpEPI5+Tpzk=");
_c = AdminLogin;
var _c;

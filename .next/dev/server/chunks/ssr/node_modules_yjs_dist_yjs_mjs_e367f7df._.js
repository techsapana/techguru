    ...
    ds.clients.forEach((dels)=>{
        ...
        for(i = 1, j = 1; i < dels.length; i++){
            ...
            if (left.clock + left.len >= right.clock) {
                dels[j - 1] = new DeleteItem(left.clock, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lib0$2f$math$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["max"](left.len, right.clock + right.len - left.clock));
            } else {
                if (j < i) {
                    dels[j] = right;
                }
...
/** eslint-env browser */ const glo = typeof globalThis !== 'undefined' ? globalThis : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
...
//# sourceMappingURL=node_modules_yjs_dist_yjs_mjs_e367f7df._.js.map
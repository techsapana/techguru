...
export default function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-blue-50 to-slate-50 pt-24 md:pt-28 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input
                    ...
                    required
                    className="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 bg-white text-slate-900 placeholder-slate-500 transition"
                  />
                  <input
                    type="email"
                    name="email"
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  className="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 bg-white text-slate-900 placeholder-slate-500 resize-none transition"
                ></textarea>

                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white font-semibold px-6 py-3 rounded-lg transition shadow-lg hover:shadow-xl"
                >
          ...
          <motion.div
            variants={fadeUpItem}
            className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300 h-full min-h-96 md:min-h-auto"
          >
            <iframe

...
export default function Faqs() {
  ...
  return (
    ...
    >
      <div className="absolute -top-20 -right-20 h-80 w-80 rounded-full bg-blue-200/30 blur-[120px]" />
      <div className="absolute -bottom-24 -left-24 h-72 w-72 rounded-full bg-sky-200/40 blur-[120px]" />

...
export default function Team() {
  ...
  return (
    ...
    >
      <div className="absolute -top-28 -right-24 h-72 w-72 rounded-full bg-blue-200/40 blur-[120px]" />
      <div className="absolute -bottom-24 -left-24 h-72 w-72 rounded-full bg-sky-200/60 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          <div className="relative h-full overflow-hidden">
            {isLoading && (
              <div className="relative rounded-3xl border border-blue-100/70 bg-white/80 p-8 shadow-sm shadow-blue-100/60 backdrop-blur">
            ...
            {!isLoading && teamMembers.length === 0 && (
              <div className="relative rounded-3xl border border-blue-100/70 bg-white/80 p-8 text-center shadow-sm shadow-blue-100/60 backdrop-blur">
            ...
            {!isLoading && teamMembers.length > 0 && (
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="group">
                    <div className="relative rounded-3xl border border-blue-100/70 bg-white/80 p-8 shadow-sm shadow-blue-100/60 backdrop-blur transition duration-300 group-hover:border-blue-200 group-hover:shadow-lg">
                      <div className="absolute inset-0 rounded-3xl bg-linear-to-br from-blue-50/70 via-white to-sky-50/60 opacity-0 transition duration-300 group-hover:opacity-100" />

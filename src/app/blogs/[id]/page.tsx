...
export default function BlogPage() {
  ...
  if (loading) {
    return (
      <section className="min-h-screen bg-linear-to-b from-slate-50 via-sky-50 to-white pt-24 md:pt-28 pb-16">
  ...
  if (!blog) {
    return (
      <section className="min-h-screen flex flex-col items-center justify-center bg-linear-to-b from-slate-50 via-sky-50 to-white pt-24 md:pt-28 px-4">
